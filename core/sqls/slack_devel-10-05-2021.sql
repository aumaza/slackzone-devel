...
--
-- Table structure for table `sd_proyectos_pagos`
--

DROP TABLE IF EXISTS `sd_proyectos_pagos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `sd_proyectos_pagos`
--

LOCK TABLES `sd_proyectos_pagos` WRITE;
/*!40000 ALTER TABLE `sd_proyectos_pagos` DISABLE KEYS */;
INSERT INTO `sd_proyectos_pagos` VALUES (1,'Silvia Medina','SM-Bienestar','SI','2021-04-07',3000.00);
/*!40000 ALTER TABLE `sd_proyectos_pagos` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-05-10 20:27:25
